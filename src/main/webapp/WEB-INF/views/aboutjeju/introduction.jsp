	  ...
	  <div>
        ...
        <div id="menuF">
            <div id="category">
                ...
                <div id="detail"><a href="${root}/aboutjeju/introduction.do">Location</a></div>
                <div id="detail"><a href="${root}/aboutjeju/introduction.do">Speciality</a></div>
                <div id="detail"><a href="${root}/aboutjeju/introduction.do">Activities</a></div>
